            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-8">
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-3 bg-white/5 border border-white/10 rounded-xl py-3 text-sm text-white hover:bg-white/10 transition-colors disabled:opacity-50 disabled:cursor-not-allowed mb-6"
                    >
                        {googleLoading ? (
                        ...
                        {googleLoading ? 'Redirecting...' : `Sign ${isLogin ? 'in' : 'up'} with Google`}
                    </button>
